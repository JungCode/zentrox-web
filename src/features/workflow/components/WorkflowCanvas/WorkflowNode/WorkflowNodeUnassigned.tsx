...
const WorkflowNodeUnassigned = ({
  ...
  return (
    <div className="border-outline-variant/50 bg-surface-container hover:border-secondary/60 hover:bg-surface-container-low cursor-pointer overflow-hidden rounded-md border border-dashed transition-all duration-150 select-none">
